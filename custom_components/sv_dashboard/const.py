...
FRONTEND_VERSION = "0.6.0-beta.30"
...
METRIC_TRAILING_FUEL_CONSUMPTION = "trailing_fuel_consumption_500km"
METRIC_REMAINING_BATTERY_ENERGY = "remaining_battery_energy_kwh"
METRIC_REMAINING_FUEL_LITERS = "remaining_fuel_liters"
