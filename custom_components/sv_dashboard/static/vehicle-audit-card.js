...
import { textFor } from "./i18n.js?v=0.6.0-beta.28";
...
class SvDashboardVehicleAuditCard extends LitElement {
  ...
  async _writeClipboard(value) {
    ...
    // Clipboard API is unavailable on some local HTTP Home Assistant origins.
    // Use the browser's synchronous copy fallback without persisting the text.
