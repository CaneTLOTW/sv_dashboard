...
const CONSUMPTION_RESERVES_TEXT = {
  de: { consumptionReserves: "Verbrauch & Reserven", electricReserve: "Elektrisch · verbleibend", fuelReserve: "Kraftstoff · verbleibend", last500km: "Letzte 500 km", trailingFuelConsumption: "Ø Kraftstoffverbrauch (500 km)" },
  en: { consumptionReserves: "Consumption & reserves", electricReserve: "Electric · remaining", fuelReserve: "Fuel · remaining", last500km: "Last 500 km", trailingFuelConsumption: "Average fuel consumption (500 km)" },
  fr: { consumptionReserves: "Consommation et réserves", electricReserve: "Électrique · restant", fuelReserve: "Carburant · restant", last500km: "500 derniers km", trailingFuelConsumption: "Consommation moyenne de carburant (500 km)" },
  it: { consumptionReserves: "Consumi e riserve", electricReserve: "Elettrico · residuo", fuelReserve: "Carburante · residuo", last500km: "Ultimi 500 km", trailingFuelConsumption: "Consumo medio carburante (500 km)" },
  es: { consumptionReserves: "Consumo y reservas", electricReserve: "Eléctrico · restante", fuelReserve: "Combustible · restante", last500km: "Últimos 500 km", trailingFuelConsumption: "Consumo medio de combustible (500 km)" },
  pt: { consumptionReserves: "Consumo e reservas", electricReserve: "Elétrico · restante", fuelReserve: "Combustível · restante", last500km: "Últimos 500 km", trailingFuelConsumption: "Consumo médio de combustível (500 km)" },
  nl: { consumptionReserves: "Verbruik en reserves", electricReserve: "Elektrisch · resterend", fuelReserve: "Brandstof · resterend", last500km: "Laatste 500 km", trailingFuelConsumption: "Gemiddeld brandstofverbruik (500 km)" },
  da: { consumptionReserves: "Forbrug og reserver", electricReserve: "Elektrisk · tilbage", fuelReserve: "Brændstof · tilbage", last500km: "Seneste 500 km", trailingFuelConsumption: "Gennemsnitligt brændstofforbrug (500 km)" },
  nb: { consumptionReserves: "Forbruk og reserver", electricReserve: "Elektrisk · igjen", fuelReserve: "Drivstoff · igjen", last500km: "Siste 500 km", trailingFuelConsumption: "Gjennomsnittlig drivstofforbruk (500 km)" },
  sv: { consumptionReserves: "Förbrukning och reserver", electricReserve: "El · kvar", fuelReserve: "Bränsle · kvar", last500km: "Senaste 500 km", trailingFuelConsumption: "Genomsnittlig bränsleförbrukning (500 km)" },
  fi: { consumptionReserves: "Kulutus ja varannot", electricReserve: "Sähkö · jäljellä", fuelReserve: "Polttoaine · jäljellä", last500km: "Viimeiset 500 km", trailingFuelConsumption: "Keskimääräinen polttoaineenkulutus (500 km)" },
  pl: { consumptionReserves: "Zużycie i rezerwy", electricReserve: "Elektrycznie · pozostało", fuelReserve: "Paliwo · pozostało", last500km: "Ostatnie 500 km", trailingFuelConsumption: "Średnie zużycie paliwa (500 km)" },
  cs: { consumptionReserves: "Spotřeba a rezervy", electricReserve: "Elektřina · zbývá", fuelReserve: "Palivo · zbývá", last500km: "Posledních 500 km", trailingFuelConsumption: "Průměrná spotřeba paliva (500 km)" },
  sk: { consumptionReserves: "Spotreba a rezervy", electricReserve: "Elektrina · zostáva", fuelReserve: "Palivo · zostáva", last500km: "Posledných 500 km", trailingFuelConsumption: "Priemerná spotreba paliva (500 km)" },
  hu: { consumptionReserves: "Fogyasztás és tartalékok", electricReserve: "Elektromos · hátralévő", fuelReserve: "Üzemanyag · hátralévő", last500km: "Utolsó 500 km", trailingFuelConsumption: "Átlagos üzemanyag-fogyasztás (500 km)" },
  ro: { consumptionReserves: "Consum și rezerve", electricReserve: "Electric · rămas", fuelReserve: "Combustibil · rămas", last500km: "Ultimii 500 km", trailingFuelConsumption: "Consum mediu de combustibil (500 km)" },
  sl: { consumptionReserves: "Poraba in rezerve", electricReserve: "Elektrika · preostalo", fuelReserve: "Gorivo · preostalo", last500km: "Zadnjih 500 km", trailingFuelConsumption: "Povprečna poraba goriva (500 km)" },
  hr: { consumptionReserves: "Potrošnja i rezerve", electricReserve: "Električno · preostalo", fuelReserve: "Gorivo · preostalo", last500km: "Posljednjih 500 km", trailingFuelConsumption: "Prosječna potrošnja goriva (500 km)" },
};
