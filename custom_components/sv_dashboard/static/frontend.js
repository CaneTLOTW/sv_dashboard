...
const packageModules = Promise.all([
  import("./trip-history-card.js?v=0.6.0-beta.4"),
  import("./charge-history-card.js?v=0.6.0-beta.4"),
  import("./gps-history-card.js?v=0.6.0-beta.4"),
...
await import("./sv_dashboard.js?v=0.6.0-beta.4");
