...
export const FRONTEND_TEXT = {
  ...
  dashboard: {
    en: {
      ...
      consumptionUsage: "Driving data & usage", quickActions: "Quick actions", chargingRange: "Charging & range", longTermStatistics: "Long-term statistics", longTermStatisticsIntro: "These charts use Home Assistant long-term statistics. Older hourly values remain available as long as the source entity provides a supported state class.", sohCapacityHistory: "SOH capacity", sohResistanceHistory: "SOH resistance", mileageHistory: "Odometer", drivenDistanceHistory: "Distance driven per month", consumptionHistory: "Average consumption (500 km)",
  ...
  fuelHistory: {
  de: { cardName: "SV Tankhistorie", cardDescription: "Erkannte Tankvorgänge aus dem Tankfüllstand", title: "Tankhistorie", empty: "Keine Tankvorgänge im gewählten Zeitraum erkannt.", loading: "Tankhistorie wird geladen …", error: "Tankhistorie konnte nicht geladen werden:", date: "Datum", liters: "Getankt", level: "Füllstand", drivingTime: "Fahrzeit", hint: "Tankvorgänge werden aus deutlichen Füllstandsanstiegen erkannt. Literwerte können direkt gemeldet oder aus der konfigurierten Tankkapazität abgeleitet sein.", estimated: "geschätzt", vehicle: "Fahrzeug", selectVehicle: "Fahrzeug auswählen …", noInstance: "Keine SV Dashboard-Instanz verfügbar.", multipleVehicles: "Mehrere Fahrzeuge gefunden. Bitte im Karteneditor ein Fahrzeug auswählen.", unavailable: "Das konfigurierte Fahrzeug ist nicht verfügbar.", auto: "Fahrzeug: automatisch · {vehicle}" },
  en: { cardName: "SV refuel history", cardDescription: "Detected refuelling events from fuel level", title: "Refuel history", empty: "No refuelling events detected in the selected period.", loading: "Loading refuel history …", error: "Could not load refuel history:", date: "Date", liters: "Fuel added", level: "Level before / after", drivingTime: "Driving time", hint: "Refuelling events are detected from clear fuel-level increases. Litres may come directly from the source or be estimated from the configured tank capacity.", estimated: "estimated", vehicle: "Vehicle", selectVehicle: "Select vehicle …", noInstance: "No SV Dashboard instance is available.", multipleVehicles: "Multiple vehicles found. Select a vehicle in the card editor.", unavailable: "The configured vehicle is unavailable.", auto: "Vehicle: automatic · {vehicle}" },
  fr: { cardName: "Historique SV des ravitaillements", cardDescription: "Ravitaillements détectés à partir du niveau de carburant", title: "Historique des ravitaillements", empty: "Aucun ravitaillement détecté sur la période sélectionnée.", loading: "Chargement de l’historique des ravitaillements…", error: "Impossible de charger l’historique des ravitaillements :", date: "Date", liters: "Carburant ajouté", level: "Niveau avant / après", drivingTime: "Temps de conduite", hint: "Les ravitaillements sont détectés par une hausse nette du niveau de carburant. La quantité peut provenir directement de la source ou être estimée à partir de la capacité configurée du réservoir.", estimated: "estimé", vehicle: "Véhicule", selectVehicle: "Sélectionner un véhicule…", noInstance: "Aucune instance SV Dashboard n’est disponible.", multipleVehicles: "Plusieurs véhicules ont été trouvés. Sélectionnez un véhicule dans l’éditeur de carte.", unavailable: "Le véhicule configuré n’est pas disponible.", auto: "Véhicule : automatique · {vehicle}" },
  it: { cardName: "Cronologia rifornimenti SV", cardDescription: "Rifornimenti rilevati dal livello carburante", title: "Cronologia rifornimenti", empty: "Nessun rifornimento rilevato nel periodo selezionato.", loading: "Caricamento cronologia rifornimenti…", error: "Impossibile caricare la cronologia rifornimenti:", date: "Data", liters: "Carburante aggiunto", level: "Livello prima / dopo", drivingTime: "Tempo di guida", hint: "I rifornimenti vengono rilevati da chiari aumenti del livello carburante. I litri possono provenire direttamente dalla fonte o essere stimati dalla capacità del serbatoio configurata.", estimated: "stimato", vehicle: "Veicolo", selectVehicle: "Seleziona veicolo…", noInstance: "Nessuna istanza SV Dashboard disponibile.", multipleVehicles: "Sono stati trovati più veicoli. Selezionane uno nell’editor della scheda.", unavailable: "Il veicolo configurato non è disponibile.", auto: "Veicolo: automatico · {vehicle}" },
  es: { cardName: "Historial SV de repostajes", cardDescription: "Repostajes detectados por el nivel de combustible", title: "Historial de repostajes", empty: "No se detectaron repostajes en el período seleccionado.", loading: "Cargando historial de repostajes…", error: "No se pudo cargar el historial de repostajes:", date: "Fecha", liters: "Combustible añadido", level: "Nivel antes / después", drivingTime: "Tiempo de conducción", hint: "Los repostajes se detectan por aumentos claros del nivel de combustible. Los litros pueden proceder directamente de la fuente o estimarse con la capacidad de depósito configurada.", estimated: "estimado", vehicle: "Vehículo", selectVehicle: "Seleccionar vehículo…", noInstance: "No hay ninguna instancia de SV Dashboard disponible.", multipleVehicles: "Se encontraron varios vehículos. Selecciona uno en el editor de la tarjeta.", unavailable: "El vehículo configurado no está disponible.", auto: "Vehículo: automático · {vehicle}" },
  pt: { cardName: "Histórico SV de abastecimentos", cardDescription: "Abastecimentos detetados pelo nível de combustível", title: "Histórico de abastecimentos", empty: "Nenhum abastecimento detetado no período selecionado.", loading: "A carregar histórico de abastecimentos…", error: "Não foi possível carregar o histórico de abastecimentos:", date: "Data", liters: "Combustível adicionado", level: "Nível antes / depois", drivingTime: "Tempo de condução", hint: "Os abastecimentos são detetados por aumentos claros do nível de combustível. Os litros podem vir diretamente da fonte ou ser estimados pela capacidade configurada do depósito.", estimated: "estimado", vehicle: "Veículo", selectVehicle: "Selecionar veículo…", noInstance: "Nenhuma instância do SV Dashboard disponível.", multipleVehicles: "Foram encontrados vários veículos. Selecione um no editor do cartão.", unavailable: "O veículo configurado não está disponível.", auto: "Veículo: automático · {vehicle}" },
  nl: { cardName: "SV tankgeschiedenis", cardDescription: "Getankte gebeurtenissen uit brandstofniveau", title: "Tankgeschiedenis", empty: "Geen tankbeurten gedetecteerd in de gekozen periode.", loading: "Tankgeschiedenis laden …", error: "Tankgeschiedenis kon niet worden geladen:", date: "Datum", liters: "Bijgetankt", level: "Niveau voor / na", drivingTime: "Rijtijd", hint: "Tankbeurten worden herkend aan duidelijke stijgingen van het brandstofniveau. Liters kunnen rechtstreeks uit de bron komen of worden geschat op basis van de ingestelde tankinhoud.", estimated: "geschat", vehicle: "Voertuig", selectVehicle: "Voertuig selecteren…", noInstance: "Geen SV Dashboard-instantie beschikbaar.", multipleVehicles: "Meerdere voertuigen gevonden. Selecteer een voertuig in de kaarteditor.", unavailable: "Het geconfigureerde voertuig is niet beschikbaar.", auto: "Voertuig: automatisch · {vehicle}" },
  da: { cardName: "SV tankhistorik", cardDescription: "Registrerede tankninger fra brændstofniveau", title: "Tankhistorik", empty: "Ingen tankninger registreret i den valgte periode.", loading: "Indlæser tankhistorik …", error: "Tankhistorik kunne ikke indlæses:", date: "Dato", liters: "Påfyldt", level: "Niveau før / efter", drivingTime: "Køretid", hint: "Tankninger registreres ud fra tydelige stigninger i brændstofniveauet. Liter kan komme direkte fra kilden eller estimeres ud fra den konfigurerede tankkapacitet.", estimated: "estimeret", vehicle: "Køretøj", selectVehicle: "Vælg køretøj…", noInstance: "Ingen SV Dashboard-instans er tilgængelig.", multipleVehicles: "Flere køretøjer fundet. Vælg et køretøj i korteditoren.", unavailable: "Det konfigurerede køretøj er ikke tilgængeligt.", auto: "Køretøj: automatisk · {vehicle}" },
  nb: { cardName: "SV tankhistorikk", cardDescription: "Registrerte fyllinger fra drivstoffnivå", title: "Tankhistorikk", empty: "Ingen fyllinger registrert i valgt periode.", loading: "Laster tankhistorikk …", error: "Tankhistorikk kunne ikke lastes:", date: "Dato", liters: "Påfylt", level: "Nivå før / etter", drivingTime: "Kjøretid", hint: "Fyllinger registreres fra tydelige økninger i drivstoffnivået. Liter kan komme direkte fra kilden eller beregnes fra konfigurert tankkapasitet.", estimated: "estimert", vehicle: "Kjøretøy", selectVehicle: "Velg kjøretøy…", noInstance: "Ingen SV Dashboard-instans er tilgjengelig.", multipleVehicles: "Flere kjøretøy funnet. Velg et kjøretøy i korteditoren.", unavailable: "Det konfigurerte kjøretøyet er ikke tilgjengelig.", auto: "Kjøretøy: automatisk · {vehicle}" },
  sv: { cardName: "SV tankhistorik", cardDescription: "Identifierade tankningar från bränslenivå", title: "Tankhistorik", empty: "Inga tankningar identifierades under vald period.", loading: "Läser in tankhistorik …", error: "Tankhistoriken kunde inte läsas in:", date: "Datum", liters: "Påfyllt", level: "Nivå före / efter", drivingTime: "Körtid", hint: "Tankningar identifieras genom tydliga ökningar av bränslenivån. Liter kan komma direkt från källan eller uppskattas från konfigurerad tankvolym.", estimated: "uppskattat", vehicle: "Fordon", selectVehicle: "Välj fordon…", noInstance: "Ingen SV Dashboard-instans är tillgänglig.", multipleVehicles: "Flera fordon hittades. Välj ett fordon i kortredigeraren.", unavailable: "Det konfigurerade fordonet är inte tillgängligt.", auto: "Fordon: automatiskt · {vehicle}" },
  fi: { cardName: "SV-tankkaushistoria", cardDescription: "Polttoainetason nousuista havaitut tankkaukset", title: "Tankkaushistoria", empty: "Valitulla ajanjaksolla ei havaittu tankkauksia.", loading: "Ladataan tankkaushistoriaa …", error: "Tankkaushistoriaa ei voitu ladata:", date: "Päivä", liters: "Lisätty polttoaine", level: "Taso ennen / jälkeen", drivingTime: "Ajoaika", hint: "Tankkaukset havaitaan selkeistä polttoainetason nousuista. Litramäärä voi tulla suoraan lähteestä tai se voidaan arvioida määritetyn säiliötilavuuden perusteella.", estimated: "arvioitu", vehicle: "Ajoneuvo", selectVehicle: "Valitse ajoneuvo…", noInstance: "SV Dashboard -instanssia ei ole käytettävissä.", multipleVehicles: "Useita ajoneuvoja löytyi. Valitse ajoneuvo korttieditorissa.", unavailable: "Määritetty ajoneuvo ei ole käytettävissä.", auto: "Ajoneuvo: automaattinen · {vehicle}" },
  pl: { cardName: "Historia tankowań SV", cardDescription: "Tankowania wykryte na podstawie poziomu paliwa", title: "Historia tankowań", empty: "Nie wykryto tankowań w wybranym okresie.", loading: "Ładowanie historii tankowań …", error: "Nie udało się wczytać historii tankowań:", date: "Data", liters: "Dolane paliwo", level: "Poziom przed / po", drivingTime: "Czas jazdy", hint: "Tankowania są wykrywane na podstawie wyraźnych wzrostów poziomu paliwa. Litry mogą pochodzić bezpośrednio ze źródła lub być oszacowane z ustawionej pojemności zbiornika.", estimated: "szacowane", vehicle: "Pojazd", selectVehicle: "Wybierz pojazd…", noInstance: "Brak dostępnej instancji SV Dashboard.", multipleVehicles: "Znaleziono wiele pojazdów. Wybierz pojazd w edytorze karty.", unavailable: "Skonfigurowany pojazd jest niedostępny.", auto: "Pojazd: automatycznie · {vehicle}" },
  cs: { cardName: "Historie tankování SV", cardDescription: "Tankování zjištěná z úrovně paliva", title: "Historie tankování", empty: "Ve vybraném období nebylo zjištěno žádné tankování.", loading: "Načítání historie tankování …", error: "Historii tankování se nepodařilo načíst:", date: "Datum", liters: "Doplněné palivo", level: "Úroveň před / po", drivingTime: "Doba jízdy", hint: "Tankování se zjišťuje podle výrazného nárůstu hladiny paliva. Litry mohou pocházet přímo ze zdroje nebo být odhadnuty z nastavené kapacity nádrže.", estimated: "odhad", vehicle: "Vozidlo", selectVehicle: "Vybrat vozidlo…", noInstance: "Není dostupná žádná instance SV Dashboard.", multipleVehicles: "Bylo nalezeno více vozidel. Vyberte vozidlo v editoru karty.", unavailable: "Nakonfigurované vozidlo není dostupné.", auto: "Vozidlo: automaticky · {vehicle}" },
  sk: { cardName: "História tankovaní SV", cardDescription: "Tankovania zistené z úrovne paliva", title: "História tankovaní", empty: "Vo vybranom období nebolo zistené žiadne tankovanie.", loading: "Načítava sa história tankovaní …", error: "Históriu tankovaní sa nepodarilo načítať:", date: "Dátum", liters: "Doplnené palivo", level: "Úroveň pred / po", drivingTime: "Čas jazdy", hint: "Tankovania sa zisťujú podľa výrazného zvýšenia hladiny paliva. Litre môžu pochádzať priamo zo zdroja alebo byť odhadnuté z nastavenej kapacity nádrže.", estimated: "odhad", vehicle: "Vozidlo", selectVehicle: "Vybrať vozidlo…", noInstance: "Nie je dostupná žiadna inštancia SV Dashboard.", multipleVehicles: "Bolo nájdených viac vozidiel. Vyberte vozidlo v editore karty.", unavailable: "Nakonfigurované vozidlo nie je dostupné.", auto: "Vozidlo: automaticky · {vehicle}" },
  hu: { cardName: "SV tankolási előzmények", cardDescription: "Üzemanyagszintből felismert tankolások", title: "Tankolási előzmények", empty: "A kiválasztott időszakban nem észlelhető tankolás.", loading: "Tankolási előzmények betöltése …", error: "A tankolási előzmények nem tölthetők be:", date: "Dátum", liters: "Betöltött üzemanyag", level: "Szint előtte / utána", drivingTime: "Menetidő", hint: "A tankolásokat az üzemanyagszint egyértelmű emelkedése alapján észleljük. A litermennyiség származhat közvetlenül a forrásból vagy a beállított tankkapacitásból becsülhető.", estimated: "becsült", vehicle: "Jármű", selectVehicle: "Jármű kiválasztása…", noInstance: "Nincs elérhető SV Dashboard-példány.", multipleVehicles: "Több jármű található. Válasszon járművet a kártyaszerkesztőben.", unavailable: "A beállított jármű nem érhető el.", auto: "Jármű: automatikus · {vehicle}" },
  ro: { cardName: "Istoric alimentări SV", cardDescription: "Alimentări detectate din nivelul combustibilului", title: "Istoric alimentări", empty: "Nu au fost detectate alimentări în perioada selectată.", loading: "Se încarcă istoricul alimentărilor …", error: "Istoricul alimentărilor nu a putut fi încărcat:", date: "Data", liters: "Combustibil adăugat", level: "Nivel înainte / după", drivingTime: "Timp de conducere", hint: "Alimentările sunt detectate din creșteri clare ale nivelului de combustibil. Litrii pot proveni direct din sursă sau pot fi estimați din capacitatea configurată a rezervorului.", estimated: "estimat", vehicle: "Vehicul", selectVehicle: "Selectați vehiculul…", noInstance: "Nu este disponibilă nicio instanță SV Dashboard.", multipleVehicles: "Au fost găsite mai multe vehicule. Selectați un vehicul în editorul cardului.", unavailable: "Vehiculul configurat nu este disponibil.", auto: "Vehicul: automat · {vehicle}" },
  sl: { cardName: "SV zgodovina točenj", cardDescription: "Točenja zaznana iz ravni goriva", title: "Zgodovina točenj", empty: "V izbranem obdobju ni bilo zaznanih točenj.", loading: "Nalaganje zgodovine točenj …", error: "Zgodovine točenj ni bilo mogoče naložiti:", date: "Datum", liters: "Dodano gorivo", level: "Raven prej / potem", drivingTime: "Čas vožnje", hint: "Točenja se zaznajo iz jasnih povečanj ravni goriva. Litri so lahko podani neposredno ali ocenjeni iz nastavljene prostornine rezervoarja.", estimated: "ocenjeno", vehicle: "Vozilo", selectVehicle: "Izberite vozilo…", noInstance: "Nobena instanca SV Dashboard ni na voljo.", multipleVehicles: "Najdenih je več vozil. Izberite vozilo v urejevalniku kartice.", unavailable: "Konfigurirano vozilo ni na voljo.", auto: "Vozilo: samodejno · {vehicle}" },
  hr: { cardName: "SV povijest točenja", cardDescription: "Točenja otkrivena iz razine goriva", title: "Povijest točenja", empty: "U odabranom razdoblju nije otkriveno točenje.", loading: "Učitavanje povijesti točenja …", error: "Povijest točenja nije se mogla učitati:", date: "Datum", liters: "Dodano gorivo", level: "Razina prije / poslije", drivingTime: "Vrijeme vožnje", hint: "Točenja se prepoznaju po jasnom porastu razine goriva. Litre može dati izvor izravno ili se mogu procijeniti iz konfiguriranog kapaciteta spremnika.", estimated: "procijenjeno", vehicle: "Vozilo", selectVehicle: "Odaberite vozilo…", noInstance: "Nema dostupne instance SV Dashboarda.", multipleVehicles: "Pronađeno je više vozila. Odaberite vozilo u uređivaču kartice.", unavailable: "Konfigurirano vozilo nije dostupno.", auto: "Vozilo: automatski · {vehicle}" },
},
};
