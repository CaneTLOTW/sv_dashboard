...
test("frontend loads new cards and fuel history is capability gated",()=>{assert.match(frontend,/dual-energy-overview-card\.js\?v=0\.6\.0-beta\.6/);assert.match(frontend,/fuel-history-card\.js\?v=0\.6\.0-beta\.6/);assert.match(strategy,/modules\.trips && supportsFuel \? \{ type: "custom:sv-dashboard-fuel-history-card"/);});
